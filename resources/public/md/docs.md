...
Two middleware functions are provided by default in the `app.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `app.handler` namespace to manage the enabled middleware.
